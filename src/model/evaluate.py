...
def run_evaluations():
    ckpt_path = "/mnt/pccfs2/backed_up/justinolcott/superviren/vmod-john/chord-pred/Chord-Prediction/logs/chord_transformer_pop_type_pe/version_0/checkpoints/chord-transformer-pop_type_pe-epoch=27-val_loss=1.80.ckpt"
